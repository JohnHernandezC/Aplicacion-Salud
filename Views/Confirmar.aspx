<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/Controllers/Confirmar.aspx.cs" Inherits="Views_Confirmar" %>
                            ...
                            <div class="booking-form">
                                ...
                                <h2 class="text-center mb-lg-3 mb-2">Ingresa tu nueva contraseña </h2>
                                        ...
                                        <div class="col-lg-3 col-md-4 col-6 mx-auto">
                                            ...
                                            <asp:Button class="form-control" ID="confirm" runat="server" Text="Confirmar contraseña" OnClick="confirmar" />
                                        </div>
                                    </div>
