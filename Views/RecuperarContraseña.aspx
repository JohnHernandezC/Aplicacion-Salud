<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/Controllers/RecuperarContraseña.aspx.cs" Inherits="Views_RecuperarContraseña" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12 mx-auto">
                            <div class="booking-form">
                                ...
                                <h2 class="text-center mb-lg-3 mb-2">Ingresa tu correo</h2>
                                        ...
                                        <div class="col-lg-3 col-md-4 col-6 mx-auto">
                                            ...
                                            <asp:Button class="form-control" ID="RContrase" runat="server" Text="Recuperar contraseña" OnClick="RContras" />
                                        </div>
                                    </div>
