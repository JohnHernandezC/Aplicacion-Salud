<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/Controllers/Registrarse.aspx.cs" Inherits="Views_Registrarse" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12 mx-auto">
                            <div class="booking-form">
                                ...
                                <h2 class="text-center mb-lg-3 mb-2">Registrate</h2>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-12">
                                            <asp:TextBox  class="form-control" ID="Cedula" runat="server" placeholder="NUMERO DOCUMENTO" required ></asp:TextBox>
                                        ...
                                        <div class="col-lg-6 col-12">
                                            <asp:TextBox  class="form-control" ID="direccion" runat="server" placeholder="DIRECCION" required ></asp:TextBox>
                                            
                                        </div>

                                       
                                        <div class="col-lg-6 col-12">
                                            <asp:TextBox  class="form-control" ID="Contraseña" runat="server" placeholder="Clave" required ></asp:TextBox>
                                        ...
                                        <div class="col-lg-3 col-md-4 col-6 mx-auto">
                                            ...
                                            <asp:Button class="form-control" ID="JBRegistrar" runat="server" Text="Registrarse" OnClick="registrarse" />
                                        </div>
                                    </div>
