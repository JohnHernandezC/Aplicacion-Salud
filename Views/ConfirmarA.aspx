<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/Controllers/ConfirmarA.aspx.cs" Inherits="Views_ConfirmarA" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Recuperar Administrador</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12 mx-auto">
                            <div class="booking-form">
                                ...
                                <h2 class="text-center mb-lg-3 mb-2">Ingresa tu nueva contraseña </h2>
    
                            
                                    

                                        <div class="col-lg-6 col-12">
                                           <asp:TextBox  class="form-control" ID="Contraseña" runat="server" placeholder="Nueva contraseña" required ></asp:TextBox>
                                        ...
                                        <div class="col-lg-3 col-md-4 col-6 mx-auto">
                                            ...
                                            <asp:Button class="form-control" ID="confirm" runat="server" Text="Confirmar contraseña" OnClick="confirmarA" />
                                        </div>
                                    </div>
