<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/Controllers/ModificarHorario.aspx.cs" Inherits="Views_ModificarHorario" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12 mx-auto">
                            <div class="booking-form">
                                ...
                                <h2 class="text-center mb-lg-3 mb-2">Ver citas</h2>
    
                                  <div class="col-lg-6 col-12">
                                            <asp:TextBox  class="form-control" ID="TB_MH" runat="server" placeholder="NUMERO DE CEDULA" required ></asp:TextBox>
                                         </div>
                                        <div class="col-lg-3 col-md-4 col-6 mx-auto">
                                            
                                            <asp:Button class="form-control" ID="SolicitarHorario" runat="server" Text="SOLICITAR HORARIO"  />
                                        </div>
                                <div class="col-lg-3 col-md-4 col-6 mx-auto">
                                            
                                            <asp:Button class="form-control" ID="B_buscarh" runat="server" Text="Agenda" OnClick="B_BUSCAR" />
                                        </div>

                                <div class="col-lg-3 col-md-4 col-6 mx-auto">
                                            
                                    <asp:GridView ID="GridHoraio" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="ODSHorario" ForeColor="#333333" GridLines="None" Visible="False">
                                        <AlternatingRowStyle BackColor="White" />
                                        <Columns>
                                            <asp:BoundField DataField="IdHorariol" HeaderText="IdHorariol" SortExpression="IdHorariol" />
                                            <asp:BoundField DataField="FechaInicio" HeaderText="FechaInicio" SortExpression="FechaInicio" />
                                            <asp:BoundField DataField="CedulaHorario" HeaderText="CedulaHorario" SortExpression="CedulaHorario" />
                                    ...
                                    <asp:ObjectDataSource ID="ODSHorario" runat="server" SelectMethod="obtenerHorario" TypeName="DAOHorarios">
                                        <SelectParameters>
                                            <asp:SessionParameter Name="buscar" SessionField="ModificarHorario" Type="String" />
